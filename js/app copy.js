...
function setPosition(element, e) {
    element.style.transform = `translate3d(${e.clientX - 13}px, ${e.clientY - 17}px, 0)`
}
...
fetch('http://localhost:1337/api/ensaios?populate=%2A')
    .then(response => response.json())
    .then(data => {
        console.log(data); // print the data object to the console  galerryimage
